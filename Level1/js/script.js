...
class Sea {
	constructor(ampValue, vertX, vertY, waveOpacity, textOffsetX, textOffsetY) {
...
function createRain() {
	...
	// const image = document.createElement("img").src = "images/water-drop.png";
	// rain.innerHTML = "";
	// rain.append(image);
...
function initSkybox(){
	...
	var urls = [
		'images/skybox/sky_down.jpg',
		'images/skybox/sky_east.jpg',
		'images/skybox/sky_north.jpg',
		'images/skybox/sky_south.jpg',
		'images/skybox/sky_up.jpg',
		'images/skybox/sky_west.jpg'
	];
...
function init() {
	...
	createBoat(-100,0,100);
	createBoat(-150,0,150);
